...
function setupData(data, result) {
    ...
    for (var index in result) {
        ...
        data.addRow([row.name, row.count, createCustomTooltip(row.desc, colors[index])]);
    }
...
function createCustomTooltip(des, color) {
    return `
        <div style="padding: 8px 8px 8px 8px; width: 110px; border-style: solid; border-color: ${color};">
